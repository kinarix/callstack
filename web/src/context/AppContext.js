    ...
    switch (action.type) {
        ...
        case 'MOVE_REQUEST': {
            ...
            const reordered = [...state.requests]
                ...
                let updated = r;
                if (r.id === requestId)
                    updated = { ...updated, project_id: projectId, folder_id: folderId };
                if (idMap.has(r.id))
                    updated = { ...updated, position: idMap.get(r.id) };
                return updated;
            })
                .sort((a, b) => {
        ...
        case 'TOGGLE_PROJECT':
            return {
                ...state,
                expandedProjects: new Set(state.expandedProjects.has(action.payload)
        ...
        case 'DELETE_FOLDER':
            return {
                ...
                requests: state.requests.map((r) => r.folder_id === action.payload ? { ...r, folder_id: null } : r),
            };
        case 'TOGGLE_FOLDER': {
